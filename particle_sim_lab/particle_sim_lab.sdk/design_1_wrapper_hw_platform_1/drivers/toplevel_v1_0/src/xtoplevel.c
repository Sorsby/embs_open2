...
void XToplevel_Set_numP(XToplevel *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XToplevel_WriteReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_NUMP_DATA, Data);
}

u32 XToplevel_Get_numP(XToplevel *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XToplevel_ReadReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_NUMP_DATA);
    return Data;
}

void XToplevel_Set_numA(XToplevel *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XToplevel_WriteReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_NUMA_DATA, Data);
}

u32 XToplevel_Get_numA(XToplevel *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XToplevel_ReadReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_NUMA_DATA);
    return Data;
}
