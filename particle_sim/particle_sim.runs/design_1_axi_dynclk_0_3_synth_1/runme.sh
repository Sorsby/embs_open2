...
HD_PWD='C:/Users/Matthew/Desktop/embs_open2/particle_sim/particle_sim.runs/design_1_axi_dynclk_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dynclk_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dynclk_0_3.tcl
